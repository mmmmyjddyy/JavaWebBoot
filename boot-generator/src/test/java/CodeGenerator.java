...
public class CodeGenerator {
    ...
    private static final String TEMPLATE_PATH = "\\boot-generator";
    private static final String TEMPLATE_FILE_PATH = System.getProperty("user.dir") + TEMPLATE_PATH + "/src/test/resources/generator/template";//模板位置
    ...
    public static void genModelAndMapper(String tableName, String modelName) {
        ...
        swaggerConfiguration.setConfigurationType("com.boot.generator.GeneratorSwagger2Model");
    ...
    public static void genService(String tableName, String modelName) {
        try {
            ...
            data.put("basePackageCore",BASE_PACKAGE_CORE);
