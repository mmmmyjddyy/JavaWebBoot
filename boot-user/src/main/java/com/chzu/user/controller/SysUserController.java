...
@Api(value = "SysUser控制类", description = "控制类接口测试")
public class SysUserController {
    ...
    public Result
<PageInfo<SysUser>> list(@RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "0") Integer size) {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "sysUser",value = "待添加的sysUser实例",paramType = "body",dataType = "SysUser",required = true)
    })
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "sysUser",value = "更新的sysUser实例",paramType = "body",dataType = "SysUser",required = true)
    })
